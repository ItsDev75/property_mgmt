...
import { CommercialPropertyMainService } from '../services/commercial_property_main.service';
import { logger } from '../utils/logger';

export class CommercialPropertyMainController {
  private propertyService: CommercialPropertyMainService;

  constructor() {
    this.propertyService = new CommercialPropertyMainService();
  }
